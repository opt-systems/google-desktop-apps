...
var opt = {
    name: 'Forms Dark',
    targetUrl: 'https://docs.google.com/forms',
    version: '1.0.0',
    out: './dist',
    overwrite: true,
    width: 1200,
...
nativefier(opt, function (error, appPath) {
    ...
    fs.copyFile(path.join(__dirname, '../common/darkreader.js'), './dist/Forms Dark-darwin-x64/Forms Dark.app/Contents/Resources/app/inject/darkreader.js', (err) => {
        if (err) throw err;
